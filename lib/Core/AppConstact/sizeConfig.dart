...
import 'package:pozitive/Core/enums/mobile_size.dart';
...
class SizeConfig {
  ...
  static double textFieldAdaptiveHeight(double height) =>
      height *
      (mobileSize == MobileSize.small
          ? mobileSizeScaleFactorVertical - 0.1
          : 1);
  static double adaptiveHeight(double height) =>
      height * mobileSizeScaleFactorVertical;
  static double adaptiveWidth(double width) =>
      width * mobileSizeScaleFactorHorizontal;
  static adaptiveVerticalSpace(double height) =>
      verticalSpace(adaptiveHeight(height));
  static adaptiveHorizontalSpace(double width) =>
      horizontalSpace(adaptiveWidth(width));
  ...
  static EdgeInsets get topAppbarPadding =>
  ...
  static EdgeInsets get smallertopPadding =>
      EdgeInsets.only(top: screenHeight * .04, left: screenWidth * 0.012);
  static EdgeInsets get topIconPadding => EdgeInsets.only(
        right: screenWidth * 0.04,
        top: screenHeight * .08,
      );
  static EdgeInsets get mediumTopPadding => EdgeInsets.only(
        top: screenHeight * .1,
      );
  ...
  static EdgeInsets get columntopPadding =>
      EdgeInsets.only(top: screenHeight * .1);
  static EdgeInsets get sidepadding =>
      EdgeInsets.only(left: screenWidth * 0.04, right: screenWidth * 0.04);
  static EdgeInsets get largeSidepadding =>
      EdgeInsets.only(left: screenWidth * 0.15);
  static EdgeInsets get largerSidepadding =>
      EdgeInsets.only(left: screenWidth * 0.1, right: screenWidth * 0.1);
  static EdgeInsets get sidelargepadding =>
      EdgeInsets.only(left: 30, right: 30);
  static EdgeInsets get innersidepadding =>
  ...
  static EdgeInsets get cmediumPadding => EdgeInsets.only(
      left: screenWidth * 0.05,
      right: screenWidth * 0.05,
      top: SizeConfig.screenHeight * .018,
  ...
  static EdgeInsets get verticalBigPadding =>
  ...
  static EdgeInsets get paddingC13 =>
      EdgeInsets.only(left: 13, right: 13, bottom: 13, top: 13);
  static EdgeInsets get verticalMediumPadding =>
      EdgeInsets.only(bottom: screenHeight * 0.004, top: screenHeight * .013);
  ...
  static EdgeInsets get cSmallVerticalPadding =>
  ...
  static SliverToBoxAdapter verticalSliverMediumSpace() {
    return SliverToBoxAdapter(
      child: verticalSpace(SizeConfig.screenHeight * .02),
    );
  }

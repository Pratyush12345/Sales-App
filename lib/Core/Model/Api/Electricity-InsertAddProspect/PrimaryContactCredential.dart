...
class ELPrimaryContactCredential{
  ...
  ELPrimaryContactCredential({this.primaryTitle,this.primaryFirstName, this.primaryLastName,this.primaryPhone,this.primaryEmail});

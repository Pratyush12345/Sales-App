...
class GroupAddPartnerAddQuickLeadNewCredential {
  String accountId;
  String command;
  ...
  String companyName;
  String cRN;
  List<ListFormSiteList> lstFormSiteList;
  ...
  GroupAddPartnerAddQuickLeadNewCredential.fromJson(Map<String, dynamic> json) {
    ...
    if (json['lstFormSiteList'] != null) {
      ...
      json['lstFormSiteList'].forEach((v) {
        lstFormSiteList.add(new ListFormSiteList.fromJson(v));
      });
    }
  }
...
class ListFormSiteList {
  ...
  ListFormSiteList.fromJson(Map<String, dynamic> json) {
    businessName = json['Business_Name'];

class ContractCustomerDetailModel {
  String accountId;
  String type;
  int quoteId;
  int intGroupid;
  ...
  Null strUniqueRefNo;
  Null strFullName;
  Null strBusinessnames;
  Null strHomeaddress;
  Null strAddress1;
  Null strAddress2;
  Null strTown; 
  Null mobileNo;
  Null registerCompanyName;
  Null registerCompanyNo;
  Null registerCharityNo;
  Null strexcesscapacity;
  Null strreactivecharge;
  Null strSiteAddress1;
  Null strSiteAddress2;
  Null strSiteTown;
  Null strPostcodeHome;
  Null strPostcodeBusiness;
  Null strPhoneHome;
  Null strPhoneBusiness;
  Null strEmailBusiness;
  Null strEmailHome;
  Null strsitecapacity;
  Null strcapacitycharge;
  Null strContractStartDate;
  Null strContractEndDate;
  Null strContractStartDateGas;
  Null strContractEndDateGas;
  Null strMPRN;
  Null strMPAN1;
  Null strMPAN2;
  Null strMPAN3;
  ...
  int intLeadType;
  int intcompanyid;
  Null strACBusinessName;
  Null strACOwnername;
  Null bitIsRHT;

  ContractCustomerDetailModel(
      {this.accountId,
      this.type,
      this.quoteId,
      this.intGroupid,
  ...
  ContractCustomerDetailModel.fromJson(Map<String, dynamic> json) {

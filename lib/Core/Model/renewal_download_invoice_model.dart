class RenewalDownloadInvoiceDetails {
  String accountId;
  int displaydaycount;
  ...
  String renewalDownloadInvoiceFilePath;
  var fuel;
  ...
  RenewalDownloadInvoiceDetails.fromJson(Map<String, dynamic> json) {

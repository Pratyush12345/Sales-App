class GetGroupVolumeDataModel {
  String status;
  String msg;
  Data data;
  String error;

  GetGroupVolumeDataModel({this.status, this.msg, this.data, this.error});

  GetGroupVolumeDataModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
...
class Data {
  ...
  Null lstPriceList;
  Null sitelist;
  List<LstGroupVolumeData> lstGroupVolumeData;
  Null lstFormSiteList;
  Null lstError;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['lstGroupVolumeData'] != null) {
      lstGroupVolumeData = new List<LstGroupVolumeData>();
      json['lstGroupVolumeData'].forEach((v) {
        lstGroupVolumeData.add(new LstGroupVolumeData.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.lstGroupVolumeData != null) {
      data['lstGroupVolumeData'] =
          this.lstGroupVolumeData.map((v) => v.toJson()).toList();
    }
...
class LstGroupVolumeData {
  int intTermType;
  double grossValueOfContract;
  double discountValueOfContract;
  double netValueOfContract;

  LstGroupVolumeData(
      {this.intTermType,
      this.grossValueOfContract,
      this.discountValueOfContract,
      this.netValueOfContract});

  LstGroupVolumeData.fromJson(Map<String, dynamic> json) {
    intTermType = json['intTermType'];
    grossValueOfContract = json['GrossValueOfContract'];
    discountValueOfContract = json['discountValueOfContract'];
    netValueOfContract = json['netValueOfContract'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['intTermType'] = this.intTermType;
    data['GrossValueOfContract'] = this.grossValueOfContract;
    data['discountValueOfContract'] = this.discountValueOfContract;
    data['netValueOfContract'] = this.netValueOfContract;
    return data;
  }
}

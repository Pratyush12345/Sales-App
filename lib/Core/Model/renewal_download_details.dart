class RenewalDownloadDetails {
  ...
  String renewalDownloadALLFilePath;
  String renewalDownloadFileZipname;
  ...
  RenewalDownloadDetails.fromJson(Map<String, dynamic> json) {

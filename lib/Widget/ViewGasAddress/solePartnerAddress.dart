...
//              height: MediaQuery.of(context).size.height*.062,
              child: Disableinnertextfield(home_Address, false, autovalidation,
                  false, TextInputType.text, "Home Address 1", (value) {
                if (value.isEmpty) {
            ...
            SizedBox(
//              height: MediaQuery.of(context).size.height*.062,
              child: Disableinnertextfield(home_Address2, false, autovalidation,
                  false, TextInputType.text, "Home Address 2", (value) {
                /*if (value.isEmpty) {
...
*/
  ...
  void soleAddressInitialData() async {
    final data = await GasBusinessTypePref.getSoleBusinessTypeAdd();
    setState(() {
  ...
  void soleAddressOnSaveAndNext() {
    setState(() {
      GasBusinessTypePref.setSoleBusinessTypeAdd(SoleBusinessCredential(

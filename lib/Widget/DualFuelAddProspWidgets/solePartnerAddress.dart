...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeAdressPostCode, false,
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              // height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeaddressPostCode1, false,
                  autovalidation, TextInputType.text, "Post Code", (value) {
                String patttern = r'^[A-Z]{1,2}[0-9][A-Z0-9]? ?[0-9][A-Z]{2}$';
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              ...
              child: innertextfield(strHomeaddressCity2, false, autovalidation,
                  TextInputType.text, "Home City ", (value) {}, context),
            ),
            SizedBox(
              height: MediaQuery.of(context).size.height * 0.022,
            ),
...
*/
  ...
  void soleAddressInitialData() async {
    final data = await BusinessTypePref.getSoleBusinessTypeAdd();
    setState(() {
  ...
  void soleAddressOnSaveAndNext() {
    setState(() {
      BusinessTypePref.setSoleBusinessTypeAdd(SoleBusinessCredential(

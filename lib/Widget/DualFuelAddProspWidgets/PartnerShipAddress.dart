  ...
  Widget owner1() {
    return Column(
      ...
      children: [
        ...
        SizedBox(
          //  height: MediaQuery.of(context).size.height * .062,
          child: innertextfield(dfstrFirstNameowner, false, autovalidation,
              TextInputType.text, "First name", (value) {
            if (value.isEmpty) {
              return 'Please enter first name';
            }
        ...
        SizedBox(
          // height: MediaQuery.of(context).size.height * .062,
          child: innertextfield(dfstrLastNameowner, false, autovalidation,
  ...
  Widget owner2() {
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height: MediaQuery.of(context).size.height * .062,
          child: innertextfield(strFirstNameowner3, false, autovalidation,
              TextInputType.text, "First name", (value) {
            // if (value.isEmpty) {
            //   return 'Please enter first name';
            // }
        ...
        SizedBox(
          height: MediaQuery.of(context).size.height * .062,
          child: innertextfield(strLastNameowner3, false, autovalidation,
              TextInputType.text, "Last name", (value) {
            /*  if (value.isEmpty) {
                                      return 'Please enter electricity night fixed commission';
                                    }*/
  ...
  Widget owner3() {
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height: MediaQuery.of(context).size.height * .062,
          child: innertextfield(strFirstNameowner4, false, autovalidation,
              TextInputType.text, "First name", (value) {
            // if (value.isEmpty) {
            //   return 'Please enter first name';
            // }
        ...
        SizedBox(
          height: MediaQuery.of(context).size.height * .062,
          child: innertextfield(strLastNameowner4, false, autovalidation,
              TextInputType.text, "Last name", (value) {
            /*  if (value.isEmpty) {
                                      return 'Please enter electricity night fixed commission';
                                    }*/
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(dfstrHomeAdressCityowner, false,
                  autovalidation, TextInputType.text, "Home City", (value) {
                /* if (value.isEmpty) {
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(dfstrHomeAdressPostCodeowner, false,
                  autovalidation, TextInputType.text, "Post Code", (value) {
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(dfstrHomeaddressCity1owner, false,
                  autovalidation, TextInputType.text, "Home City", (value) {
                /*if (value.isEmpty) {
                  return 'Please enter City';
                }*/
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(dfstrHomeaddressPostCode1owner, false,
                  autovalidation, TextInputType.text, "Post Code", (value) {
                String patttern = r'^[A-Z]{1,2}[0-9][A-Z0-9]? ?[0-9][A-Z]{2}$';
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeAdressCityowner3, false,
                  autovalidation, TextInputType.text, "Home City", (value) {
                /* if (value.isEmpty) {
                  return 'Please enter City';
                }*/
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeAdressPostCodeowner3, false,
                  autovalidation, TextInputType.text, " Post Code", (value) {
                String patttern = r'^[A-Z]{1,2}[0-9][A-Z0-9]? ?[0-9][A-Z]{2}$';
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeaddressCity1owner3, false,
                  autovalidation, TextInputType.text, "Home City", (value) {
                /* if (value.isEmpty) {
                  return 'Please enter City';
                }*/
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeaddressPostCode1owner3, false,
                  autovalidation, TextInputType.text, " Post Code", (value) {
                String patttern = r'^[A-Z]{1,2}[0-9][A-Z0-9]? ?[0-9][A-Z]{2}$';
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeAdressCityowner4, false,
                  autovalidation, TextInputType.text, "Home City", (value) {
                if (value.isEmpty) {
                  return 'Please enter City';
                }
            ...
            SizedBox(
//              height: MediaQuery.of(context).size.height*.062,
              child: innerLongtextfield(5, home_Address2owner4, autovalidation,
                  TextInputType.text, "Home Address 2", (value) {
                /*if (value.isEmpty) {
                              return 'Please enter Site Address 2';
                            }*/
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeAdressPostCodeowner4, false,
                  autovalidation, TextInputType.text, "Post Code", (value) {
                String patttern = r'^[A-Z]{1,2}[0-9][A-Z0-9]? ?[0-9][A-Z]{2}$';
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeaddressCity1owner4, false,
                  autovalidation, TextInputType.text, "Home City", (value) {
                if (value.isEmpty) {
                  return 'Please enter City';
                }
...
//              height: MediaQuery.of(context).size.height*.062,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeaddressPostCode1owner4, false,
                  autovalidation, TextInputType.text, " Post Code", (value) {
                String patttern = r'^[A-Z]{1,2}[0-9][A-Z0-9]? ?[0-9][A-Z]{2}$';

...
class _llcAddressesState extends State<llcAddresses> {
  ...
  void llpAddressInitialData() async {
    final data = await GasBusinessTypePref.getLLCBusinessTypeAdd();
    setState(() {
  ...
  void llcAddressOnSaveAndNext() {
    setState(() {
      GasBusinessTypePref.setLLCBusinessTypeAdd(LLCBusinessCredential(

...
*/
  ...
  void partnershipAddressInitialData() async {
    final data = await GasBusinessTypePref.getPartnerShipBusinessTypeAdd();
    setState(() {
  ...
  void partnerShipAddressOnSaveAndNext() {
    setState(() {
      GasBusinessTypePref.setPartnerShipBusinessTypeAdd(
  ...
  Widget owner1() {
    return Column(
      ...
      children: [
        ...
        SizedBox(
          // height: MediaQuery.of(context).size.height * .062,
          child: innertextfield(strFirstNameowner, false, autovalidation,
        ...
        SizedBox(
          // height: MediaQuery.of(context).size.height * .062,
          child: innertextfield(strLastNameowner, false, autovalidation,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
//              height: MediaQuery.of(context).size.height*.062,
              child: innerLongtextfield(5, home_Addressowner, autovalidation,
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeAdressCityowner, false,
            ...
            SizedBox(
//              height: MediaQuery.of(context).size.height*.062,
              child: innerLongtextfield(5, home_Address2owner, autovalidation,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
//              height: MediaQuery.of(context).size.height*.062,
              child: innerLongtextfield(5, strHomeaddress1owner, autovalidation,
                  TextInputType.text, "Home Address 1", (value) {
                return null;
              }, context),
            ),
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(strHomeaddressCity1owner, false,
                  autovalidation, TextInputType.text, "Home City", (value) {
                //
                return null;
              }, context),
            ...
            SizedBox(
//              height: MediaQuery.of(context).size.height*.062,
              child: innerLongtextfield(5, strHomeaddress2owner, autovalidation,
                  TextInputType.text, "Home Address 2", (value) {
                /*if (value.isEmpty) {
                              return 'Please enter Site Address 2';
                            }*/

...
class ViewElectricity3Year extends StatefulWidget {
  ...
  const ViewElectricity3Year({this.quoteId, this.requestQuote, this.title});

  @override
  _ViewElectricity3YearState createState() => _ViewElectricity3YearState();
}

class _ViewElectricity3YearState extends State<ViewElectricity3Year> {
  ...
  // double ele3YearDAYRequiredUpLift;
  // double ele3YearNightRequiredUpLift;

  double ele3YearDayAffiliateUpLift;
  double ele3YearNightAffiliateUpLift;
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<ElectricityOneYearViewModel>(
        onModelReady: (model) => model.initializeData(widget.requestQuote, '3'),
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                                ...
                                //color: Color.fromRGBO(18, 122, 69, 1),
                                child: Text(
                                  "End Date : ${widget.requestQuote.contractenddate3}",
                                  style: TextStyle(
                                      color: Color.fromRGBO(18, 122, 69, 1),
                                      fontWeight: FontWeight.w600),
                                )),
                          ...
                          Container(
                            ...
                            child: AppTextField(
                                ...
                                validator: (value) {
                                  ...
                                  RegExp regExp = new RegExp(patttern);
                                  if (value.length != 0) {
                                    if (ele3YearDayAffiliateUpLift != null) {
                                      if (ele3YearDayAffiliateUpLift > 0) {
                                        if (double.tryParse(value) > 50) {
                                          return 'Max value is 50';
                                        } else {}
                                      }
                                    ...
                                    } else if (ele3YearNightAffiliateUpLift !=
                                        null) {
                                      if (ele3YearNightAffiliateUpLift > 0) {
                                        if (double.tryParse(value) > 50) {
                                          return 'Max value is 50';
                                        } else {}
                                      }

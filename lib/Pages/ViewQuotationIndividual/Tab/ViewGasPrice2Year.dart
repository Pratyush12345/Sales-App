...
class ViewGasPrice2Year extends StatefulWidget {
  ...
  const ViewGasPrice2Year({this.quoteId, this.requestQuote, this.title});

  @override
  _ViewGasPrice2YearState createState() => _ViewGasPrice2YearState();
}

class _ViewGasPrice2YearState extends State<ViewGasPrice2Year> {
  ...
  //double gas2YearStandingVar;
  double gas2YearAffiliateUnitVar;
  ...
  Widget build(BuildContext context) {
    ...
    return widget.quoteId != null
        ? BaseView<GasPriceOneViewModel>(
            onModelReady: (model) =>
                model.initializeData(widget.requestQuote, '2'),
                                  ...
                                  Container(
                                    ...
                                    child: AppTextField(
                                      ...
                                      validator: (value) {
                                        ...
                                        RegExp regExp = new RegExp(patttern);
                                        if (value.length != 0) {
                                          if (gas2YearAffiliateUnitVar !=
                                              null) {
                                            if (gas2YearAffiliateUnitVar > 0) {
                                              if (double.tryParse(value) > 25) {
                                                return 'Max value is 25';
                                              } else {}
                                            }

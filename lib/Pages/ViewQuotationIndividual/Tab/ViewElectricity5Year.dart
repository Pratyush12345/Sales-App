...
class ViewElectricity5Year extends StatefulWidget {
  ...
  const ViewElectricity5Year({this.quoteId, this.requestQuote, this.title});

  @override
  _ViewElectricity5YearState createState() => _ViewElectricity5YearState();
}

class _ViewElectricity5YearState extends State<ViewElectricity5Year> {
  ...
  //double ele5YearDAYRequiredUpLift;
  //double ele5YearNightRequiredUpLift;
  double ele5YearDayAffiliateUpLift;
  double ele5YearNightAffiliateUpLift;
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<ElectricityOneYearViewModel>(
        onModelReady: (model) => model.initializeData(widget.requestQuote, '5'),
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                                ...
                                //color: Color.fromRGBO(18, 122, 69, 1),
                                child: Text(
                                  "End Date : ${widget.requestQuote.contractenddate5}",
                                  style: TextStyle(
                                      color: Color.fromRGBO(18, 122, 69, 1),
                                      fontWeight: FontWeight.w600),
                                )),
                          ...
                          Container(
                            ...
                            child: AppTextField(
                                ...
                                validator: (value) {
                                  ...
                                  RegExp regExp = new RegExp(patttern);
                                  if (value.length != 0) {
                                    if (ele5YearNightAffiliateUpLift != null) {
                                      if (ele5YearNightAffiliateUpLift > 0) {
                                        if (double.tryParse(value) > 50) {
                                          return 'Max value is 50';
                                        } else {}
                                      }
                                    ...
                                    } else if (ele5YearDayAffiliateUpLift !=
                                        null) {
                                      if (ele5YearDayAffiliateUpLift > 0) {
                                        if (double.tryParse(value) > 50) {
                                          return 'Max value is 50';
                                        } else {}
                                      }
                                  ...
                                  if (widget.quoteId != null) {
                                    if (_formKey.currentState.validate()) {
                                      ...
                                      model.generateIndividualContractView(
                                          ...
                                          widget.requestQuote,
                                          context,
                                          widget.requestQuote.baserateDayUnit5,
                                          widget
                                              .requestQuote.baserateNightUnit5);
                                    }
                                  }
                                } else {
                                  setState(() {

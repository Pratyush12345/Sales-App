...
class ViewGasPrice3Year extends StatefulWidget {
  ...
  const ViewGasPrice3Year({this.quoteId, this.requestQuote, this.title});

  @override
  _ViewGasPrice3YearState createState() => _ViewGasPrice3YearState();
}

class _ViewGasPrice3YearState extends State<ViewGasPrice3Year> {
  ...
  //double gas3YearStandingVar;
  double gas3YearAffiliateUnitVar;
  ...
  Widget build(BuildContext context) {
    ...
    return widget.quoteId != null
        ? BaseView<GasPriceOneViewModel>(
            onModelReady: (model) =>
                model.initializeData(widget.requestQuote, '3'),
                                  ...
                                  child: AppTextField(
                                    ...
                                    textInputFormatter: [
                                      DecimalTextInputFormatter(
                                          decimalRange: 4), WhitelistingTextInputFormatter(
                                    RegExp(r'^\d+.?\d{0,4}'),
                                  ),
                                    ],
                                    validator: (value) =>

...
class ViewGasPricePerYear extends StatefulWidget {
  final String quoteId;
  final ViewQuotationPageArgument argument;
  final RequestQuoteViewButtonModel requestQuote;
  final String title;

  const ViewGasPricePerYear(
      {this.quoteId, this.argument, this.requestQuote, this.title});

  @override
  _ViewGasPricePerYearState createState() => _ViewGasPricePerYearState();
}

class _ViewGasPricePerYearState extends State<ViewGasPricePerYear> {
                                  ...
                                  Container(
                                    ...
                                    child: AppTextField(
                                        ...
                                        validator: (value) {
                                          ...
                                          RegExp regExp = new RegExp(patttern);
                                          if (value.length != 0) {
                                            if (gasAffiliateUnitVar != null) {
                                              if (gasAffiliateUnitVar > 0) {

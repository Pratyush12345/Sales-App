...
class ViewGasPrice5Year extends StatefulWidget {
  ...
  const ViewGasPrice5Year({this.quoteId, this.requestQuote, this.title});

  @override
  _ViewGasPrice5YearState createState() => _ViewGasPrice5YearState();
}

class _ViewGasPrice5YearState extends State<ViewGasPrice5Year> {
  ...
  //double gas5YearStandingVar;
  double gas5YearAffiliateUnitVar;
  ...
  Widget build(BuildContext context) {
    ...
    return widget.quoteId != null
        ? BaseView<GasPriceOneViewModel>(
            onModelReady: (model) =>
                model.initializeData(widget.requestQuote, '5'),
                            ...
                            enableGenContract
                                ? InkWell(
                                    onTap: () {
                                      ...
                                      //             .text !=
                                      //         '' &&
                                      //     gas5YearStandingVar != null) {
                                      //   if (widget.quoteId != null) {
                                      //     if (_formKey.currentState
                                      //             .validate() &&
                                      //         gas5YearStandingVar <= 1.5) {
                                      //       _formKey.currentState.save();

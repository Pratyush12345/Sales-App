...
import 'package:pozitive/Core/ViewModel/DualFuelAddProspect-viewModel/PaymentDuelFuel-ViewModel.dart';
...
class _PaymentDetailsTabState extends State<PaymentDetailsTab> {
  ...
  Widget build(BuildContext context) {
    ...
    return user.accountId != null
        ? BaseView<PaymentDuelFuelViewModel>(
                            ...
                            children: <Widget>[
                              ...
                              InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    DFPref.getDualFuelBillingAddressValues()
                                        .then((value) {
                                      //print(value.strBillAddress1);
                                    });
                                    model.onSaveAndNext();
                                    int index = globals.tabController2.index;
                                    globals.tabController2.animateTo(index + 1);

                                    //globals.tabController2.animateTo(9);
                                  }),
                              SizedBox(
                                height:

...
import 'package:pozitive/Core/ViewModel/DualFuelAddProspect-viewModel/billingAddress-ViewModel.dart';
...
class _BillingAddressTabState extends State<BillingAddressTab> {
  ...
  Widget build(BuildContext context) {
    ...
    return user.accountId != null
        ? BaseView<DualFuelBillingAddressAddProspectViewModel>(
...
//              height: MediaQuery.of(context).size.height*.062,
                        ...
                        //Text("`Post`Code",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,color: Color.fromRGBO(31, 33, 29, 1)),),
                        RichText(
                          text: TextSpan(
                            text: 'PostCode',
                            style: TextStyle(

...
class ViewGasELEPricePerYear extends StatefulWidget {
  final String quoteId;
 // final ViewQuotationPageArgument argument;
  final RequestQuoteViewButtonModel requestQuote;
  final String title;

  const ViewGasELEPricePerYear(
      {this.quoteId, this.requestQuote, this.title});

  @override
  _ViewGasELEPricePerYearState createState() => _ViewGasELEPricePerYearState();
}

class _ViewGasELEPricePerYearState extends State<ViewGasELEPricePerYear> {

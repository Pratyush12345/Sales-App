...
import 'package:pozitive/Pages/Add-Prospect-FormTab/DualFuel/dualfuel.dart';
...
class _BusinessDetailsTabState extends State<BusinessDetailsTab>
  ...
  // void showBusinessTab(bool isBusinessSelected){
  //   setState(() {
  //     if(isBusinessSelected){
  //       setState(() {
  //         DualFuelTabe(isSelected:isBusinessSelected);
  //       });
  //
  //     }
  //   });
                ...
                body: Padding(
                  ...
                  child: Form(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: Disableinnertextfield(
                              ...
                              "", (value) {
                            String patttern =
                                r'^(?:(?:\(?(?:07|\+)([1-4]{1}\d\d|[1-9]{1}\d?)\)?)?[\-\.\ \\\/]?)?((?:[+0]9)?[0-9]{15}$)?$';
                    ...
                    return 'Please enter Company Reg. No.';
                        ...
                        //FormBuilderPhoneField(maxLength: 10,controller: model.mobile,initialValue: "Enter Phone",),

...
import 'package:pozitive/Core/ViewModel/EleAddProspectViewModels/ele_siteAddress_viewmodel.dart';
...
class _SiteAddressTabState extends State<SiteAddressTab> {
  ...
  Widget build(BuildContext context) {
    ...
    return user.accountId != null
        ? BaseView<EleSiteAddressAddProspectViewModel>(
...
//              height: MediaQuery.of(context).size.height*.062,
                        ...
                        //     } else {
                        //       setState(() {
                        //         AppConstant.showFailToast(context, "Please add required fields");
